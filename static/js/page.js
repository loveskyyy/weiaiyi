...
/* Info */
// 创建一个分页列表 <ul class="page" maxshowpageitem="5" pagelistcount="10"  id="page"></ul>

$.fn.extend({
  "initPage": function(listCount,currentPage,fun) {

    var maxshowpageitem = $(this).attr("maxshowpageitem");                          // maxshowpageitem - 最多显示的页码数字
    if (maxshowpageitem != null && maxshowpageitem > 0 && maxshowpageitem != "") {
      page.maxshowpageitem = maxshowpageitem;
    }

    var pagelistcount = $(this).attr("pagelistcount");                              // pagelistcount - 每一个页面显示的内容条数
    if (pagelistcount != null && pagelistcount > 0 && pagelistcount != "") {
      page.pagelistcount = pagelistcount;
    }

    var pageId = $(this).attr("id");                                                // 列表 ul 的 id
    page.pageId = pageId;
    if (listCount < 0) {
      listCount = 0;
    }
